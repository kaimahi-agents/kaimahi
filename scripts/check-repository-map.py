...
MAP_EDITS = [
    ...
    ("| `scripts/` | 22 (6 embedded in the binary, 16 operator) | 3 | 44",
     "| `scripts/` | 22 (6 embedded in the binary, 15 operator) | 3 | 44",
    ...
    ("58 of the 69 are named", "59 of the 69 are named",
