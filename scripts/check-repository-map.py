...
MAP_EDITS = [
    ...
    ("| `scripts/` | 22 (6 embedded in the binary, 16 operator) | 3 | 53",
     "| `scripts/` | 22 (6 embedded in the binary, 15 operator) | 3 | 53",
    ...
    ("65 of the 78 are named", "64 of the 78 are named",
