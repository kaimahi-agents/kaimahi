...
MAP_EDITS = [
    ...
    ("| `scripts/` | 22 (6 embedded in the binary, 16 operator) | 3 | 50",
     "| `scripts/` | 22 (6 embedded in the binary, 15 operator) | 3 | 50",
    ...
    ("62 of the 75 are named", "61 of the 75 are named",
