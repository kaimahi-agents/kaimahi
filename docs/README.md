...
| Govern an agent that is not a kagent agent — what my runtime has to be told, and what it cannot have | [foreign-runtime.md](foreign-runtime.md) | the credential, the two seam URLs, and one NetworkPolicy selector |
