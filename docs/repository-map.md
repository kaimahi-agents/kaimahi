...
|---|---|---|---|
| `kmx/app` | 80 | Installed | Command orchestration, the Orka runtime adapter, interactive agent console, shared chat UI, host inference and native platform operations. |
