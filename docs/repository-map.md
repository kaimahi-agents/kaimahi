...
## `docs/` — 37 tracked files, two audiences and two assets
...
**Maintainer and process (11):** `development.md`, `repository-map.md`
(this file),
...
`reviews/2026-09-09-kars-upstream-drafts.md`,
