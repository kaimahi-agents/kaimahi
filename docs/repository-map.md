...
|---|---|---|---|
| `kmx/app` | 83 | Installed | Command orchestration, runtime adapters, the Orka lifecycle adapter, interactive agent console, shared chat UI, host inference and native platform operations. |
