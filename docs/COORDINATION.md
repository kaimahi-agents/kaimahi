...
| Plane/code retirement: final approvals | worker session; branch `cleanup/retire-budget-approvals` | ACTIVE | Based on main after #184. Remove remaining approval/grant execution and interfaces; preserve ordinary model caps/accounting, SQL history, migration and both authoring paths. |
