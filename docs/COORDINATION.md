...
| Plane/code retirement: gateway/tool approvals | worker session; branch `cleanup/retire-tool-governance` | ACTIVE | Based on main after #183. Narrow legacy scaffold exception approved; both authoring paths and model migration preserved. Budget approvals/seam-adjacent cleanup follows last. |
