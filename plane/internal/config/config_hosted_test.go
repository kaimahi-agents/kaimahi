...
func TestParseHostedUpstreamShape(t *testing.T) {
	for _, tc := range []struct {
		...
		{"in-cluster service.ns", "http://model.orka-system:8080", "", true},
		{"in-cluster full suffix", "http://model.orka-system.svc.cluster.local:8080", "", true},
		...
		{"ca_file without marker", "http://model.orka-system:8080", `,"ca_file":"/etc/x"`, false},
